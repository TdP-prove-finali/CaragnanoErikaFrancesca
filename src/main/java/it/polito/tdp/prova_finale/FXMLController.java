...
//    	List<String> nuoviacquisti = new ArrayList<String>();
    ...
    void handleGenera(ActionEvent event) {
    	...
    	if(this.livello1.getValue()!=null) {
        	...
        	this.txtSimulazione.appendText("Durata totale del piano: " + String.format("%.2f",piano.getDurataTotale())+ " ore \n");
        	this.txtSimulazione.appendText("Numero di corsi nel piano: " + piano.getCorsi().size() + " \n");
